...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Устанавливаем цвет фона в тему Telegram
      ...
      {userData ? (
            ...
            <div style={styles.detailsGrid}>
              ...
              {userData.allows_write_to_pm !== undefined && (
                <div style={styles.detailItem}>
                  ...
                  <span style={{
                    ...styles.detailValue,
                    color: userData.allows_write_to_pm ? '#10b981' : '#6b7280'
                  }}>
                    {userData.allows_write_to_pm ? '✅ Разрешён' : '❌ Запрещён'}
                  </span>
                </div>
              )}
            </div>
        ...
        <div style={styles.errorCard}>
          ...
          <p style={styles.errorText}>
            Запустите это приложение через Telegram для получения информации о пользователе
          </p>
          <button 
