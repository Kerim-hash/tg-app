...
const FORM_T = {
  ...
  es: {
    ...
    errEmail: "Por favor, introduzca una dirección de correo electrónico válida.",
...
export default function SupportFormDrawer({
  t,
  language,
  triggerHaptic,
  isOpen,
        ...
        {!isSuccess ? (
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div>
              ...
              />
              {errors.email && (
                <span style={{ display: "block", color: "#EF4444", fontSize: "11px", marginTop: "4px", textAlign: "left" }}>
                  {errors.email}
                </span>
              )}
            </div>
