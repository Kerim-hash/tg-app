...
const DICT: Record<string, {
  gamingTitle: string;
  adultsTitle: string;
  gamingSubtitle: string;
  adultsSubtitle: string;
  noLogsNote: string;
  wireguardProtocol: string;
  fastestToday: string;
  hidesRealIp: string;
  ddosProtection: string;
  noActivityLogs: string;
  lowLatencyNodes: string;
  lessLag: string;
  bypassesBlocks: string;
  worksOnPlatforms: string;
  capsules: { label: string; value: string; isLeft: boolean }[];
}> = {
  en: {
    gamingTitle: "No slowdowns. No logs. No drama",
    adultsTitle: "Nobody knows what you're doing. That's the point",
    gamingSubtitle: "iGuard routes your traffic smarter",
    adultsSubtitle: "No logs. No history. No way to trace it back to you:",
    noLogsNote: "iGuard keeps zero activity logs. Nothing to hand over, ever",
    wireguardProtocol: "WireGuard protocol",
    fastestToday: "Fastest available today",
    hidesRealIp: "Hides your real IP",
    ddosProtection: "No one can DDoS or track you mid-match",
    noActivityLogs: "No activity logs",
    lowLatencyNodes: "Low-latency nodes",
    lessLag: "Less lag, more stable connection",
    bypassesBlocks: "Bypasses regional blocks",
    worksOnPlatforms: "Works on iOS, Android, macOS, Windows",
    capsules: [
      { label: "Your IP address", value: "Replaced with VPN server IP", isLeft: true },
      { label: "ISP traffic logs", value: "ISP sees only encrypted tunnel", isLeft: false },
      { label: "Browser history leaks", value: "All DNS routed through VPN", isLeft: true },
      { label: "Device fingerprinting", value: "Location masked by server", isLeft: false },
    ]
  },
  ru: {
    gamingTitle: "Никаких зависаний. Без логов. Без драмы",
    adultsTitle: "Никто не знает, что вы делаете. В этом и суть",
    gamingSubtitle: "iGuard маршрутизирует ваш трафик умнее",
    adultsSubtitle: "Без логов. Без истории. Невозможно отследить вас:",
    noLogsNote: "iGuard не сохраняет никаких логов. Нечего передавать, никогда",
    wireguardProtocol: "Протокол WireGuard",
    fastestToday: "Самый быстрый на сегодня",
    hidesRealIp: "Скрывает ваш IP",
    ddosProtection: "Защита от DDoS и отслеживания",
    noActivityLogs: "Без логов активности",
    lowLatencyNodes: "Узлы с низким пингом",
    lessLag: "Меньше задержек, больше стабильности",
    bypassesBlocks: "Обходит региональные блоки",
    worksOnPlatforms: "Работает на iOS, Android, macOS, Windows",
    capsules: [
      { label: "Ваш IP-адрес", value: "Заменен на IP-адрес VPN", isLeft: true },
      { label: "Логи трафика провайдера", value: "Провайдер видит только шифрованный туннель", isLeft: false },
      { label: "Утечки истории браузера", value: "Весь DNS идет через VPN", isLeft: true },
      { label: "Цифровой отпечаток устройства", value: "Местоположение скрыто сервером", isLeft: false },
    ]
  },
  uz: {
    gamingTitle: "Hech qanday qotishlarsiz. Loglarsiz. Dramalarsiz",
    adultsTitle: "Nima qilayotganingizni hech kim bilmaydi. Asosiy maqsad ham shu",
    gamingSubtitle: "iGuard trafigingizni yanada aqlliroq yo'naltiradi",
    adultsSubtitle: "Loglarsiz. Tarixsiz. Sizni kuzatib bo'lmaydi:",
    noLogsNote: "iGuard hech qanday loglarni saqlamaydi. Hech qachon hech narsani topshirmaydi",
    wireguardProtocol: "WireGuard protokoli",
    fastestToday: "Bugungi kunda eng tezkori",
    hidesRealIp: "IP manzilingizni yashiradi",
    ddosProtection: "DDoS va kuzatuvdan himoya",
    noActivityLogs: "Faollik loglarisiz",
    lowLatencyNodes: "Kichik pingli tugunlar",
    lessLag: "Kamroq kechikish, ko'proq barqarorlik",
    bypassesBlocks: "Mintaqaviy bloklarni chetlab o'tadi",
    worksOnPlatforms: "iOS, Android, macOS, Windows tizimlarida ishlaydi",
    capsules: [
      { label: "Sizning IP manzilingiz", value: "VPN serverining IP manziliga almashtirildi", isLeft: true },
      { label: "Provayder trafigi loglari", value: "Provayder faqat shifrlangan tunnelni ko'radi", isLeft: false },
      { label: "Brauzer tarixi sizib chiqishi", value: "Barcha DNS VPN orqali yo'naltiriladi", isLeft: true },
      { label: "Qurilmaning raqamli izi", value: "Joylashuv server tomonidan yashirilgan", isLeft: false },
    ]
  },
  by: {
    gamingTitle: "Ніякіх завісанняў. Без логаў. Без драмы",
    adultsTitle: "Ніхто не ведае, што вы робіце. У гэтым і сэнс",
    gamingSubtitle: "iGuard маршрутызуе ваш трафік разумней",
    adultsSubtitle: "Без логаў. Без гісторыі. Немагчыма адсачыць вас:",
    noLogsNote: "iGuard не захоўвае ніякіх логаў. Няма чаго перадаваць, ніколі",
    wireguardProtocol: "Пратакол WireGuard",
    fastestToday: "Самы хуткі на сёння",
    hidesRealIp: "Схавае ваш IP",
    ddosProtection: "Абарона ад DDoS і адсочвання",
    noActivityLogs: "Без логаў актыўнасці",
    lowLatencyNodes: "Вузлы з нізкім пінгам",
    lessLag: "Менш затрымак, больш стабільнасці",
    bypassesBlocks: "Абыходзіць рэгіянальныя блакіроўкі",
    worksOnPlatforms: "Працуе на iOS, Android, macOS, Windows",
    capsules: [
      { label: "Ваш IP-адрас", value: "Заменены на IP-адрас VPN", isLeft: true },
      { label: "Логі трафіку правайдэра", value: "Правайдэр бачыць толькі шыфраваны тунэль", isLeft: false },
      { label: "Уцечкі гісторыі браўзера", value: "Увесь DNS ідзе праз VPN", isLeft: true },
      { label: "Лічбавы адбітак прылады", value: "Месцазнаходжанне схавана серверам", isLeft: false },
    ]
  }
};
...
export default function HowItWorksStep({
  ...
  return (
    <div className="w-full flex flex-col box-border">
      <h2 className={`text-[24px] text-center text-white m-0 mb-[10px] leading-tight font-sans ${
        campaign === "adults" ? "px-5" : ""
      } ${campaign === "gaming" ? "max-w-[300px] mx-auto" : ""}`}>
        {campaign === "gaming" ? currentDict.gamingTitle : currentDict.adultsTitle}
      </h2>

      <p className={`text-[16px] text-center text-white/40 m-0 mb-6 leading-relaxed font-sans ${
        campaign === "adults" ? "px-5" : ""
      }`}>
        {campaign === "gaming" ? currentDict.gamingSubtitle : currentDict.adultsSubtitle}
      </p>

      {campaign === "adults" ? (
        <div className="flex flex-col w-full">
          {currentDict.capsules.map((item, idx) => {
            const borderRadius = item.isLeft ? "0px 38px 38px 0px" : "38px 0px 0px 38px";

            return (
              <div
                key={idx}
                className={`w-[82%] h-[76px] relative overflow-hidden ${
                  item.isLeft ? "ml-0 mr-auto" : "mr-0 ml-auto"
                }`}
              >
                <GradientBlock
                  label=""
                ...
                >
                  <div className={`absolute inset-0 flex flex-col justify-center box-border text-left ${
                    item.isLeft ? "pl-9 pr-6" : "pl-6 pr-9"
                  }`}>
                    <span className={`${
                      language === "ru" || language === "by" ? "text-[12px]" : "text-[14px]"
                    } text-brand-gray font-mono mb-0.5`}>
                      {item.label}
                    </span>
                    <span className={`text-white font-sans ${
                      language === "ru" || language === "by" ? "text-[14px]" : "text-[16px]"
                    }`}>
                      {item.value}
                    </span>
                  </div>
          ...
          <div className="flex-1 flex flex-col gap-2.5 min-h-0">
            ...
            <div className="h-[90px] rounded-[30px] bg-brand-dark-gray p-3 px-5 flex flex-col justify-between box-border">
              <div className="flex flex-col">
                <span className={`text-white font-sans ${
                  language === "ru" || language === "by" ? "text-[12px]" : "text-[16px]"
                }`}>
                  {currentDict.bypassesBlocks}
                </span>
              </div>
