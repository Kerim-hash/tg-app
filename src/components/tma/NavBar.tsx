...
const SupportIcon = ({ active }: { active: boolean }) => (
 <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M13.3346 6.66663H16.668C17.1282 6.66663 17.5013 7.03972 17.5013 7.49996V16.6666L14.7236 14.359C14.5739 14.2347 14.3856 14.1666 14.191 14.1666H7.5013C7.04106 14.1666 6.66797 13.7935 6.66797 13.3333V10.8333" stroke="white" stroke-linejoin="round"/>
<path d="M12.5 3.33337H3.33333C2.8731 3.33337 2.5 3.70647 2.5 4.16671V13.3334L5.27774 11.0257C5.42736 10.9014 5.61574 10.8334 5.81025 10.8334H12.5C12.9602 10.8334 13.3333 10.4603 13.3333 10V4.16671C13.3333 3.70647 12.9602 3.33337 12.5 3.33337Z" fill="white" stroke="white" stroke-linejoin="round"/>
</svg>

);

type IconComponent = ({ active }: { active: boolean }) => JSX.Element;

export default function NavBar({ t, currentTab, onTabChange }: NavBarProps) {
        ...
        return (
          <button
            ...
            style={{
              ...
              padding: "8px 2px",
              borderRadius: "19px",
              background: active ? "rgba(247, 246, 244, 0.06)" : "transparent",
              border: active ? "1px solid rgba(255, 255, 255, 0.25)" : "1px solid transparent",
              backdropFilter: active ? "blur(76.3px)" : "none",
              WebkitBackdropFilter: active ? "blur(76.3px)" : "none",
              display: "flex",
